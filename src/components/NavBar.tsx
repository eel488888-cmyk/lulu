          ...
          {NAV_ITEMS.map((item) => (
            <li key={item.target}>
              <button
                ...
                className="drop-shadow-[0_1px_2px_rgba(0,0,0,0.8)] relative rounded-full px-3 py-1 text-sm font-medium transition-all text-white/90 hover:bg-white/15 hover:text-white"
              >
                {item.label}
              </button>
            </li>
